...
class YourClassName:
    ...
    def graphics(self):
        banner = """
  _____   __  __    _____     _____   __   __     _____    _____   __  __     _____  __ __    
 /\ __/\/\  /\  /\/\  __/\  /\_____\ /\_\ /_/\   /\___/\  /\ __/\ /\_\\  /\ /\_____\/_/\__/\  
 ) )__\/\ \ \/ / /) )(_ ) )( (_____/( ( (_) ) ) / / _ \ \ ) )__\/( ( (/ / /( (_____/) ) ) ) ) 
/ / /    \ \__/ // / __/ /  \ \__\   \ \___/ /  \ \(_)/ // / /    \ \_ / /  \ \__\ /_/ /_/_/  
\ \ \_    \__/ / \ \  _\ \  / /__/_  / / _ \ \  / / _ \ \\ \ \_   / /  \ \  / /__/_\ \ \ \ \  
 ) )__/\  / / /   ) )(__) )( (_____\( (_( )_) )( (_( )_) )) )__/\( (_(\ \ \( (_____\)_) ) \ \ 
 \/___\/  \/_/    \/____\/  \/_____/ \/_/ \_\/  \/_/ \_\/ \/___\/ \/_//__\/ \/_____/\_\/ \_\/ 
                                                                                                """
...
def add_useragent():
	try:
		with open("./nsfw.txt","r") as fp:
			uagents = re.findall(r"(.+)\n",fp.read())
	except FileNotFoundError:
		cprint('[-] No file named \'nsfw.txt\',failed to load User-Agents','yellow')
		return []
	return uagents
...
def main():
	...
	options = parser.add_argument_group('\033[1;32moptions\033[0m','')
